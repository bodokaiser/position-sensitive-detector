...
\begin{equation}
	\frac{w_d}{\rho_d}\nabla^2V=J_\text{sat}\left(e^{eV_d/k_BT}-1\right)-J_\text{photo}
	\label{eq:lucovsky}
\end{equation}

% TODO: time-dependent expansion of Lucovsky
\begin{equation}
	\nabla^2V=-f_s
	\label{eq:lucovsky_expansion}
\end{equation}

\begin{figure}[H]
	\centering
	\begin{tikzpicture}
% TODO: Woltring75. Fig. 2-4
	\end{tikzpicture}
	\caption{Contact configurations a lateral photodiode.}
\end{figure}
...
\end{equation}
% TODO: approximate for reverse bias and mention benefits thereof (refer to highlighted parts in Woltring75)
