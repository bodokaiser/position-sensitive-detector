...
\begin{equation}
	\nabla^2V=\frac{\rho_d}{w_d}J_s\left(e^{eV_d/k_BT}-1\right)-\frac{\rho_d}{w_d}J_p\label{eq:lucovsky_exact}
\end{equation}

% TODO: mention benefits of reverse bias (refer to highlighted parts in Woltring75)
\begin{align}
	\nabla^2V\approx-\frac{\rho_d}{w_d}\left(J_s+J_p\right) && \text{when } eV_d/k_BT\ll1 \label{eq:lucovsky_reverse_bias}	
\end{align}
...
\begin{equation}
	V_p(x,y, t=0)=-I_p\frac{\rho_d}{w_d}\delta(x-x_0)\delta(y-y_0)
