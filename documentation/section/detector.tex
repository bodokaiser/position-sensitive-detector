...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\draw[dashed, line width=0.5] (2.5, 1.5) -- +(1, 0);
		...
		\foreach \x in {0, ..., 5} {
			\filldraw[fill=white] (0.25+0.4*\x, 1.1) circle (.11);
			\filldraw[fill=black] (3.75+0.4*\x, 1.9) circle (.09);
		}
	\end{tikzpicture}
	\caption{Energy and electrochemical potential in equilibrium of a p-n junction with holes (white) and electrons (black).}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\draw[dashed, line width=0.5] (2, 1.5) -- +(2, -0.8);
		\filldraw[draw=black, fill=gray!70] (2, 3.3) -- ++(2, -1.4) -- ++(0, -1) -- ++(-2, 1.4) -- ++(0, 1);
		\filldraw[draw=black, fill=gray!70] (2, 1.3) -- ++(2, -1.4) -- ++(0, -1) -- ++(-2, 1.4) -- ++(0, 1);
		\foreach \x in {0, ..., 4} {
			\filldraw[fill=white] (0.2+0.4*\x, 1.1) circle (.11);
			\filldraw[fill=black] (4.2+0.4*\x, 1.1) circle (.09);
		}
	\end{tikzpicture}
	\caption{Energy and electrochemical potential of a reverse biased p-n junction with holes (white) and electrons (black).}
\end{figure}
